...
@section('content')
    <div class="container">
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('dayBook.store') }}" method="POST" class="max-w-xl mx-auto px-4 py-6">
                    @csrf

                    <div class="mb-4">
                        <label class="form-label">Type</label>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="type" id="expense" value="2">
                            <label class="form-check-label" for="expense">
                                Expense
                            </label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="type" id="income" value="1">
