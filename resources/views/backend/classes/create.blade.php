        ...
        <div class="table w-full mt-8 bg-white rounded">
            <form action="{{ route('classes.store') }}" method="POST" class="w-full max-w-xl px-6 py-12">
                ...
                <div class="md:flex md:items-center mb-6">
                    ...
                    <div class="md:w-2/3">
                        <input id="academy" name="type" type="checkbox" value="academy" class="mr-1 type-checkbox"> <label for="academy" class="mr-4">Academy</label>
                        <input id="school" name="type" type="checkbox" value="school" class="mr-1 type-checkbox"> <label for="school">School</label>
                    </div>
                </div>
